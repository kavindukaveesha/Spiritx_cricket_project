...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    { name: 'My Team', href: '/dashboard/team', icon: Users, active: false },
    { name: 'Leaderboard', href: '/dashboard/leaderboard', icon: Trophy, active: false },
    ...
    <div className="min-h-screen bg-background dark">
        ...
        <div className="h-full flex flex-col">
          ...
          <div className={`mt-6 px-3 ${!sidebarCollapsed ? 'mb-4' : 'mb-2'}`}>
            <div className={`rounded-lg bg-primary/5 p-3 ${sidebarCollapsed ? 'text-center' : ''}`}>
              <HelpCircle className={`h-5 w-5 text-primary ${sidebarCollapsed ? 'mx-auto' : 'mb-2'}`} />
              {!sidebarCollapsed && (
                <>
                  <h5 className="font-medium text-sm mb-1">Need Help?</h5>
                  <p className="text-xs text-muted-foreground">Check our documentation for help with your fantasy cricket journey.</p>
      ...
      <div className={`fixed top-0 right-0 transition-all duration-300 z-30 ${sidebarCollapsed ? 'lg:left-20' : 'lg:left-64'} left-0 bg-card shadow-sm border-b border-border`}>
        <div className="h-16 px-4 flex items-center justify-between">
          ...
          <h1 className="text-xl font-bold text-foreground md:hidden">Spirit11</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center">
              <Button variant="ghost" className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium hidden lg:block">Alex Morgan</span>
